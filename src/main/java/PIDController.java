/* Example of usage in robot code

public PIDController drivePID = new PIDController(sensors.getInMetric(), 50, 0.75);
while(sensors.getInMetric() - 50 > 0.1 || sensors.getInMetric < -0.1) {
  driveTrain.set(drivePID.getOutput());
  drivePID.updateError(sensors.getInMetric());
}
*/
